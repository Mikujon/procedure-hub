...
export function ProcedureListRow({ id, title, code, departmentName, status, meta, date }: ProcedureListRowProps) {
  return (
    <Link href={`/procedures/${id}`} className="flex items-center justify-between gap-4 px-4 py-3 hover:bg-muted">
